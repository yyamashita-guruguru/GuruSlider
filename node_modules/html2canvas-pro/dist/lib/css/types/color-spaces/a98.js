...
const a98FromXYZ = (args) => {
    const [r, g, b] = (0, exports.a98Linear2a98)((0, exports.xyz2a98Linear)([args[0], args[1], args[2]]));
    return [r, g, b, args[3]];
};
...
const convertA98rgb = (args) => {
    const srgb_linear = (0, srgb_1.xyz2rgbLinear)((0, exports.a98Linear2xyz)((0, exports.a982a98Linear)([args[0], args[1], args[2]])));
