 ...
 */
const p3ToXYZ = (args) => {
    const p3_linear = (0, exports.p32p3Linear)([args[0], args[1], args[2]]);
...
const p3FromXYZ = (args) => {
    const [r, g, b] = (0, exports.p3Linear2p3)((0, exports.xyzToP3Linear)([args[0], args[1], args[2]]));
    return [r, g, b, args[3]];
};
...
const convertP3 = (args) => {
    const xyz = (0, exports.p3ToXYZ)([args[0], args[1], args[2]]);
