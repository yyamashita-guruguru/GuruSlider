...
const proPhotoToXYZ = (args) => {
    const prophoto_linear = (0, exports.proPhotoToProPhotoLinear)([args[0], args[1], args[2]]);
...
const proPhotoFromXYZ = (args) => {
    const [r, g, b] = (0, exports.proPhotoLinearToProPhoto)((0, exports.xyzToProPhotoLinear)((0, color_utilities_1.d65toD50)([args[0], args[1], args[2]])));
    return [r, g, b, args[3]];
};
...
const convertProPhoto = (args) => {
    const xyz = (0, exports.proPhotoToXYZ)([args[0], args[1], args[2]]);
